...
def load_pretrained_weights(network, fname, verbose=False):
    ...
    c = {k: v for k, v in pretrained_dict.items()
    ...
    #for name, param in mod.named_parameters():
        #if name in pretrained_dict.keys() and 'decoder' not in name:
            #param.requires_grad = False
    """with open('/data7/runzejiang/nnUNet_results/Dataset048_wmh/nnUNetTrainer__nnUNetPlans__3d_fullres/fold_0/aaa.txt','w') as f:
        for key, value in pretrained_dict.items():
            f.write( '\n'+key)"""
